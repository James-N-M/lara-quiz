...
//    // Questions Test
    ...
    public function it_can_create_a_quiz_question()
    {
        ...
        $this->post(route('lara-quizzes-questions.store'), $question);

        $this->assertDatabaseHas('lara_quiz_questions', $question);
    }

    /** @test */
    public function it_can_create_a_quiz_question_with_choices()
    {
        $question = [
            'question' => "Do you like cheese ?",
        ];
        ...
        $choices = [
          'choice_text_1' => 'Choice Text example',
          'correct_1' => true,
          'choice_text_2' => 'Choice 2 Text example',
          'correct_2' => false,
          'choice_text_3' => 'Choice 3 Text example',
          'correct_3' => true,
          'choice_text_4' => 'Choice 4 Text example',
          'correct_4' => false,
        ];

        $attributes = array_merge($question, $choices);

        $this->post(route('lara-quizzes-questions.store'), $attributes);
